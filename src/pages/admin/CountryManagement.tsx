      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            { title: "Avg. Rate", value: "$0.035", change: "-$0.003", icon: Globe, gradient: "from-purple-500 to-pink-500" },
            { title: "High Traffic", value: "24", change: "+2", icon: Globe, gradient: "from-orange-500 to-red-500" }
          ].map((stat, index) => (
        ...
        <Card className="shadow-xl border-0">
          <CardHeader className="bg-gradient-to-r from-emerald-50 to-cyan-50 border-b border-emerald-100">
            <CardTitle className="text-gray-900">Countries & Rates</CardTitle>
            <CardDescription>Manage country configurations and SMS rates</CardDescription>
          </CardHeader>
              ...
              <TableBody>
                {countries.map((country) => (
                  <TableRow key={country.id} className="hover:bg-emerald-50/50 transition-colors">
                    ...
                    <TableCell className="font-semibold text-green-600">{country.rate}</TableCell>
                    <TableCell>
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${getTrafficColor(country.traffic)}`}>
                        {country.traffic}
                      </span>
                    </TableCell>
                    <TableCell>
        ...
        {showAddForm && (
          <Card className="shadow-2xl border-0 bg-gradient-to-br from-white to-emerald-50">
            <CardHeader className="bg-gradient-to-r from-emerald-600 to-cyan-600 text-white rounded-t-lg">
              ...
              <CardDescription className="text-emerald-100">Configure a new country route</CardDescription>
            </CardHeader>
